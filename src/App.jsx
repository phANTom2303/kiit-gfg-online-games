...
function App() {
  ...
  if (choice == 1) {
    ...
    return (<>
      <Header text={"Fancy Snakes & Ladders"} onImgClick={() => setChoice(0)} />
      <FancySL />
    </>
    );
    ...
    return (
      <>
        ...
        <div className="cardList">
          ...
          <GameCard onCardClick={() => setChoice(3)} gameName={"Fancy S&L"} imgPath={"../../images/banners/snake-and-ladders-banner.jpg"} playerCount={6} gameDuration={"30 min."} />
