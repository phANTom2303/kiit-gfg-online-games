      ...
      {popUp && (
        <div className="fixed top-0 z-40 h-full w-full">
          <div className="absolute inset-0 z-10 h-full w-full items-center flex justify-center bg-[#000000]/40">
            <div className="h-[80%] w-[85%] max-w-[800px] bg-blue-500 rounded-3xl flex flex-col items-center justify-start shadow-lg shadow-blue-700">
              ...
              <div className="w-full pb-6 px-6">{infos[game - 1]}</div>
            </div>
          </div>
        </div>
      )}
